...
const CheckA = () => {
  useEffect(() => {
    ...
    const carrosselItems = carrossel.querySelectorAll(".carrossel .carrossel-item");
    ...
    return () => {
      window.removeEventListener("resize", createcarrossel);
      carrossel.removeEventListener("mousedown", () => {});
      carrossel.removeEventListener("mouseup", () => {});
      container.removeEventListener("mouseleave", () => {});
      carrossel.removeEventListener("mousemove", () => {});
      carrossel.removeEventListener("touchstart", () => {});
      carrossel.removeEventListener("touchend", () => {});
